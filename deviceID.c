...
The bug is that the deviceID function was ignoring the '0's somehow, may be in the comparison of character bounds ">'0'" instead of ">='0'"
Why did it only impact a small percentage of units?
The issue occurs when there are more than one 0 in the device ID. I guess that number was small.
